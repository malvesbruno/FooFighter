...
# paused
PAUSE_FONT = 'graphics/font/chinese rocks rg.otf'
PAUSE_FONT_SIZE = 60
...
monster_data = {
    'squid': {'health': 100, 'exp': 100, 'damage': 20,
              'attack_type': 'sparkle', 'attack_sound': 'audio/attack/slash.wav',
              'speed': 3, 'resistance': 3, 'attack_radius': 80, 'notice_radius': 360},
    'raccoon': {'health': 300, 'exp': 250, 'damage': 40,
                'attack_type': 'sparkle', 'attack_sound': 'audio/attack/claw.wav',
                'speed': 2, 'resistance': 3, 'attack_radius': 120, 'notice_radius': 400},
    'scorpion': {'health': 1000, 'exp': 1000, 'damage': 70,
                'attack_type': 'slash', 'attack_sound': 'audio/attack/claw.wav',
                'speed': 2, 'resistance': 3, 'attack_radius': 80, 'notice_radius': 400},
    'spirit': {'health': 70, 'exp': 110, 'damage': 8,
               'attack_type': 'slash', 'attack_sound': 'audio/attack/fireball.wav',
